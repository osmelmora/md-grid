...
describe('<Col />', function () {
  ['span', 'xsSpan', 'smSpan', 'mdSpan', 'lgSpan', 'xlSpan', 'offset', 'xsOffset', 'smOffset', 'mdOffset', 'lgOffset', 'xlOffset'].forEach(function (prop) {
    return testCase(prop, _defineProperty({}, prop, 4));
  });
});